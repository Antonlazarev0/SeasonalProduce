...
class SeasonalDatabaseHelper extends SQLiteOpenHelper {
    ...
    private void updateMyDatabase(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        if(oldVersion < 1) {
            ...
            insertFruit(db, "Apple",
                    ...
                    "Autumn, Winter",
                    R.drawable.apple,
                    "http://www.taste.com.au/recipes/collections/apple-recipes");
            ...
            insertFruit(db, "Apricot",
                    ...
                    "Summer",
                    R.drawable.apricot,
                    "http://www.taste.com.au/search-recipes/?q=apricot");
            ...
            insertFruit(db, "Banana",
                    ...
                    R.drawable.banana,
                    "http://www.taste.com.au/search-recipes/?q=banana");
            ...
            insertFruit(db, "Berry",
                    ...
                    "Spring, Summer",
                    R.drawable.berry,
                    "http://www.taste.com.au/search-recipes/?q=berry");
            ...
            insertFruit(db, "Cherry",
                    ...
                    "Summer",
                    R.drawable.cherry,
                    "http://www.taste.com.au/search-recipes/?q=cherry");
            ...
            insertFruit(db, "Fig",
                    ...
                    "Summer, Autumn",
                    R.drawable.fig,
                    "http://www.taste.com.au/search-recipes/?q=fig");
            ...
            insertFruit(db, "Grapefruit",
                    ...
                    "http://www.taste.com.au/search-recipes/?q=grapefruit");
            ...
            insertFruit(db, "Grape",
                    ...
                    "Summer, Autumn",
                    R.drawable.grape,
                    "http://www.taste.com.au/search-recipes/?q=grape");
            ...
            insertFruit(db, "Kiwifruit",
                    ...
                    "http://www.taste.com.au/search-recipes/?q=kiwifruit");
            ...
            insertFruit(db, "Lemons",
                    ...
                    "Spring, Winter",
                    R.drawable.lemon,
                    "http://www.taste.com.au/search-recipes/?q=lemon");
            ...
            insertFruit(db, "Lime",
                    ...
                    "Spring, Winter",
                    R.drawable.lime,
                    "http://www.taste.com.au/search-recipes/?q=lime");
            ...
            insertFruit(db, "Mandarin",
                    ...
                    R.drawable.mandarin,
                    "http://www.taste.com.au/search-recipes/?q=mandarin");
            ...
            insertFruit(db, "Melon",
                    ...
                    "Summer, Autumn",
                    R.drawable.melon,
                    "http://www.taste.com.au/search-recipes/?q=melon");
            ...
            insertFruit(db, "Orange",
                    ...
                    R.drawable.orange,
                    "http://www.taste.com.au/search-recipes/?q=orange");
            ...
            insertFruit(db, "Peach",
                    ...
                    "Summer",
                    R.drawable.peach,
                    "http://www.taste.com.au/search-recipes/?q=peach");
            ...
            insertFruit(db, "Pear",
                    ...
                    "Winter, Summer, Autumn",
                    R.drawable.pear,
                    "http://www.taste.com.au/search-recipes/?q=pear");
            ...
            insertFruit(db, "Plum",
                    ...
                    "Summer",
                    R.drawable.plum,
                    "http://www.taste.com.au/search-recipes/?q=plum");
        }
        ...
        if (oldVersion < 3) {
            ...
            insertVege(db, "Artichoke",
                    ...
                    "http://www.taste.com.au/search-recipes/?q=artichoke");

            insertVege(db, "Asparagus",
                    ...
                    "http://www.taste.com.au/search-recipes/?q=asparagus");
            ...
            insertVege(db, "Basil",
                    ...
                    "Summer",
                    R.drawable.basil,
                    "http://www.taste.com.au/search-recipes/?q=basil");
            ...
            insertVege(db, "Beans",
                    ...
                    R.drawable.bean,
                    "http://www.taste.com.au/search-recipes/?q=beans");

            insertVege(db, "Beetroot",
                    ...
                    "Spring, Summer, Autumn, Winter",
                    R.drawable.beetroot,
                    "http://www.taste.com.au/search-recipes/?q=beetroot");

            insertVege(db, "Broccoli",
                    ...
                    "Spring, Winter",
                    R.drawable.broccoli,
                    "http://www.taste.com.au/search-recipes/?q=broccoli");

            insertVege(db, "Brussel Sprouts",
                    ...
                    "http://www.taste.com.au/search-recipes/?q=brussel+sprouts");

            insertVege(db, "Cabbage",
                    ...
                    "Autumn, Winter",
                    R.drawable.cabbage,
                    "http://www.taste.com.au/search-recipes/?q=cabbage");

            insertVege(db, "Capsicum",
                    ...
                    "Spring, Summer, Autumn",
                    R.drawable.capsicum,
                    "http://www.taste.com.au/search-recipes/?q=capsicum");

            insertVege(db, "Carrots",
                    ...
                    "Spring, Summer, Autumn, Winter",
                    R.drawable.carrot,
                    "http://www.taste.com.au/search-recipes/?q=carrots");

            insertVege(db, "Cauliflower",
                    ...
                    "http://www.taste.com.au/search-recipes/?q=cauliflower");

            insertVege(db, "Celery",
                    ...
                    "Autumn, Winter",
                    R.drawable.celery,
                    "http://www.taste.com.au/search-recipes/?q=celery");
            ...
            insertVege(db, "Corn",
                    ...
                    "Summer, Autumn",
                    R.drawable.corn,
                    "http://www.taste.com.au/search-recipes/?q=corn");

            insertVege(db, "Cucumber",
                    ...
                    "Spring, Summer, Autumn",
                    R.drawable.cucumber,
                    "http://www.taste.com.au/search-recipes/?q=cucumber");

            insertVege(db, "Eggplant",
                    ...
                    "Summer, Autumn",
                    R.drawable.eggplant,
                    "http://www.taste.com.au/search-recipes/?q=eggplant");
            ...
            insertVege(db, "Leek",
                    ...
                    "Spring, Summer, Autumn, Winter",
                    R.drawable.leek,
                    "http://www.taste.com.au/search-recipes/?q=leek");

            insertVege(db, "Lettuce",
                    ...
                    "Spring, Summer, Autumn, Winter",
                    R.drawable.lettuce,
                    "http://www.taste.com.au/search-recipes/?q=lettuce");

            insertVege(db, "Onions",
                    ...
                    "Spring, Summer, Autumn, Winter",
                    R.drawable.onion,
                    "http://www.taste.com.au/search-recipes/?q=onions");

            insertVege(db, "Parsley",
                    ...
                    "Spring, Summer, Autumn, Winter",
                    R.drawable.parsley,
                    "http://www.taste.com.au/search-recipes/?q=parsley");

            insertVege(db, "Parsnip",
                    ...
                    "Spring, Autumn, Winter",
                    R.drawable.parsnip,
                    "http://www.taste.com.au/search-recipes/?q=parsnip");
            ...
            insertVege(db, "Peas",
                    ...
                    "Spring, Summer, Autumn, Winter",
                    R.drawable.peas,
                    "http://www.taste.com.au/search-recipes/?q=peas");

            insertVege(db, "Potato",
                    ...
                    "Spring, Summer, Autumn, Winter",
                    R.drawable.potato,
                    "http://www.taste.com.au/search-recipes/?q=potato");

            insertVege(db, "Rhubarb",
                    ...
                    "Spring, Summer, Autumn, Winter",
                    R.drawable.rhubarb,
                    "http://www.taste.com.au/search-recipes/?q=rhubarb");

            insertVege(db, "Silverbeet",
                    ...
                    "http://www.taste.com.au/search-recipes/?q=silverbeet");

            insertVege(db, "Spinach",
                    ...
                    "Spring, Autumn, Winter",
                    R.drawable.spinach,
                    "http://www.taste.com.au/search-recipes/?q=spinach");

            insertVege(db, "Squash",
                    ...
                    "Spring, Summer, Autumn",
                    R.drawable.squash,
                    "http://www.taste.com.au/search-recipes/?q=squash");

            insertVege(db, "Sweet Potato",
                    ...
                    "http://www.taste.com.au/search-recipes/?q=sweet+potato");

            insertVege(db, "Tomato",
                    ...
                    "Summer, Autumn",
                    R.drawable.tomato,
                    "http://www.taste.com.au/search-recipes/?q=tomato");

            insertVege(db, "Turnip",
                    ...
                    "Winter",
                    R.drawable.turnip,
                    "http://www.taste.com.au/search-recipes/?q=turnip");

            insertVege(db, "Zucchini",
                    ...
                    "Spring, Summer, Autumn",
                    R.drawable.zucchini,
                    "http://www.taste.com.au/search-recipes/?q=zucchini");
        }
    ...
    private static void insertFruit(SQLiteDatabase db, String name, String description, String season, int resourceId, String recipe) {
        ...
        fruitValues.put("RECIPE", recipe);
        db.insert("FRUIT", null, fruitValues);
    }

    private static void insertVege(SQLiteDatabase db, String name, String description, String season, int resourceId, String recipe) {
        ContentValues vegeValues = new ContentValues();
        vegeValues.put("NAME", name);
        vegeValues.put("DESCRIPTION", description);
        vegeValues.put("SEASON", season);
        vegeValues.put("IMAGE_RESOURCE_ID", resourceId);
        vegeValues.put("RECIPE", recipe);
